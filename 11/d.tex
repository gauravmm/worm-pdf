...
\msgbox{\strong{PHQ.Armsmaster:}  You have a sec?}

\msgbox{\strong{Guild.Dragon:}  Reading the most monotonous data on seismic activity and Behemoth's possible movements.  Ugly code.  Distract me, I beg you.}

\msgbox{\strong{PHQ.Armsmaster:}  Hearing something.  Can you listen in?}

A few seconds passed, then it came again.

\msgbox{\strong{Guild.Dragon:}  I hear it.  Wait.  Changing the settings on your microphones so I can triangulate the source.}
...
\msgbox{\strong{Guild.Dragon:}  Vent, behind and above you.}
