...
``\ldotsI don't know why I said that out loud.  You fucking mention that ever again, and-``
...
\strong{Canister A:}  F-1-6-1-1, \emph{`Deus', }85% mixture.
Added: C-0-0-7-2, `Balance', 15% mixture.\emph{           To be consumed by Client 1}



\strong{Canister B:} R-0-9-3-6, `Jaunt', 70% mixture.           Added: C-0-0-7-2, `Balance', 30% mixture.\emph{           To be consumed by Client 2}\strong{Canister C:} C-2-0-6-2, `Prince', 55% mixture.\emph{           Added: O-0-1-2-1, `Aegis', 30% mixture.}           Added: C-0-0-7-2, `Balance', 15% mixture.\emph{           To be consumed by Client 3}\strong{Canister D:} M-0-0-4-2, `Vestige', 75% mixture.           Added: C-0-0-7-2, `Balance', 25% mixture\emph{           To be consumed by Client 4}



\strong{Canister E:} X-0-7-9-6, `Division', 80% mixture.           Added: C-0-0-7-2, `Balance', 20% mixture\emph{           To be consumed by Client 5}\strong{Canister F:} E-0-7-1-2, `Robin', 60% mixture.           Added: C-0-0-7-2, `Balance', 40% mixture\emph{           To be consumed by Client 6}
